                        ...
                        <div class="card-header">
                            <h3>Edit Vision
                                <a class="btn btn-success float-right btn-sm" href="{{route('visions.view')}}">
                                    <i class="fa fa-list"></i> Vision Lists</a>
                            </h3>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <form method="post" action="{{route('visions.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="title" class="from-control" rows="7">{{$editData->title}}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    ?url('public/upload/vision_images/'.$editData->image):url 
